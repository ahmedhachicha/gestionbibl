...
class __TwigTemplate_f52f0b8678a9711164ce308fc50e23f53b61a624cc2a99996d19c5ab17563295 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        ";
        // line 13
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["registrationForm"]) || array_key_exists("registrationForm", $context) ? $context["registrationForm"] : (function () { throw new RuntimeError('Variable "registrationForm" does not exist.', 13, $this->source); })()), "user", [], "any", false, false, false, 13), 'row');
        echo "
        ";
        // line 14
...
{% endblock %}
", "security/register.html.twig", "C:\\Users\\Ahmed\\Desktop\\gestionbibl\\templates\\security\\register.html.twig");
    }
}
